var bow , arrow,  background, redB, pinkB, greenB ,blueB ,arrowGroup, exglo, re, ge, be, pe;
...
function preload(){  
  ...
  exglo = loadSound("explosion-de-un-globo.mp3");
